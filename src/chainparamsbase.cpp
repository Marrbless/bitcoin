...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-testgatewayallocationheight=<height>", "Activate experimental gateway allocation (regtest-only; fresh chainstate required).", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
    argsman.AddArg("-testgatewaykeys=<gateway_pubkey>:<hasher_pubkey>", "Compressed public keys used by the experimental block assembler (regtest-only).", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
