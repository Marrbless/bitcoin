# Historical format v3 evidence

These results belong to the earlier v3 certificate and its source commits.
Current fixed v4 validation is in [VALIDATION.md](VALIDATION.md).
They are retained as historical evidence, not counted as v4 passes.
